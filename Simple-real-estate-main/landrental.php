...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><b>Land Rentals</b></h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Land Rentals</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel"><b>Land Rentals</b></h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="connection8.php" method="POST">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="">Rental ID</label>
                            <input type="text" class="form-control" name="rental_id" placeholder="Rental ID" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="rental_date" placeholder="Rental Date">
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <form action="connection8.php" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="">Rental ID</label>
                            <input type="text" class="form-control" id="update_rental_id" name="rental_id" >
                        </div>
                        <div class="form-group">
                            <label for="">Customer ID</label>
                        ...
                        <div class="form-group">
                            <label for="">Rental Date</label>
                            <input type="text" class="form-control" id="update_rental_date" name="rental_date">
                        </div>
                        <div class="form-group">
                            <label for="">Return Date</label>
                            <input type="text" class="form-control" id="update_return_date" name="return_date" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
    ...
    <div class="container ml-3">
        ...
        <table class="table table-striped table-bordered mt-4">
            ...
            <tbody>
                ...
                $fetch_query = "SELECT * FROM land_rentals";
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.update_data').click(function(e) {
                ...
                $('#update_return_date').val(return_date);

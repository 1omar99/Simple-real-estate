...
<header class="header">
   ...
   <nav class="navbar nav-1">
      <section class="flex">
         <a href="home2.php" class="logo"><i class="fas fa-house"></i>ZAM-ZAM Real Estate</a>
         ...
         <div class="menu">
            ...
            <!--<li><a href="#">buy<i class="fas fa-angle-down"></i></a>-->
              ...
              <!-- <li><a href="#">sell<i class="fas fa-angle-down"></i></a> -->
               ...
               <li><a href="registclient.php">post property</a>
                   <!-- <ul>
                     <li><a href="#">house</a></li>
                     <li><a href="#">flat</a></li>
                     <li><a href="#">shop</a></li>
               ...
               <li><a href="view_property.php">property list</a>
                   <!-- <ul>
                     <li><a href="#">house</a></li>
                     <li><a href="#">flat</a></li>
                     <li><a href="#">shop</a></li>
         ...
         <div class="flex">
            ...
            <div class="box">
               ...
               <select name="minimum" class="input" required>
                ...
                <opt<option value="20000000">2 Cr</option>
                 ion value="30000000">3 Cr</option>
...
<section class="services">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <img src="images/buying-house.jpg " alt="">
         <h3>buy house</h3>
         <p>You can get house for .</p>
      </div>

      <div class="box">
         <img src="images/rent-houmse.jpg  " alt="">
         <h3>rent house</h3>
         <p>Get Your Rental House.</p>
      </div>

      <div class="box">
         <img src=" images/selling-house.jpg " alt="">
         <h3>sell house</h3>
         <p>Sell Your House.</p>
      </div>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="thumb">
            ...
            <img src="images/pexels-jovydas-2462015.jpg" alt="">
         </div>
      ...
      <div class="box">
         ...
         <div class="thumb">
            ...
            <img src="images/pexels-binyaminmellish-106399.jpg " alt="">
         </div>
         <h3 class="name">modern flats and appartments</h3>
         <p class="location"><i class="fas fa-map-marker-alt"></i><span>andheri, mumbai, india - 401303</span></p>
         <div class="flex">
      ...
      <div class="box">
         ...
         <div class="thumb">
            ...
            <img src="images/pexels-pixabay-209296.jpg  " alt="">
         </div>
         <h3 class="name">modern flats and appartments</h3>
         <p class="location"><i class="fas fa-map-marker-alt"></i><span>andheri, mumbai, india - 401303</span></p>
         <div class="flex">
      ...
      <div class="box">
         ...
         <div class="thumb">
            ...
            <img src=" images/pexels-pixabay-280222.jpg" alt="">
         </div>
         <h3 class="name">modern flats and appartments</h3>
         <p class="location"><i class="fas fa-map-marker-alt"></i><span>andheri, mumbai, india - 401303</span></p>
         <div class="flex">
      ...
      <div class="box">
         ...
         <div class="thumb">
            ...
            <img src="images/pexels-thgusstavo-2102587.jpg  " alt="">
         </div>
         <h3 class="name">modern flats and appartments</h3>
         <p class="location"><i class="fas fa-map-marker-alt"></i><span>andheri, mumbai, india - 401303</span></p>
         <div class="flex">
...
<footer class="footer">
    <div class="flex">
        ...
        <div class="box">
            ...
            <a href="#"><i class="fas fa-envelope"></i><span>info@mywebsite.com</span></a>
            <a href="#"><i class="fas fa-map-marker-alt"></i><span>123 Main St, Anytown, USA</span></a>
        </div>
    </div>
    <div class="credit">© 2024 My Website | All rights reserved. Designed by <span>Me</span></div>
</footer>
